...
fields) are deferred to Phase 14, where the contraction
...
\tightlist
\item
  \textbf{Rank-3 / rank-4 tensor fields.} Deferred to Phase 14.
\item
  \textbf{Expression-template contraction layer.} Deferred to Phase 14
  alongside the
