...
\passthrough{\lstinline!Field!} for the output. Phase 14 may replace
...
\item
  ...
  Phase 14 may add a unifying templated form when rank-3 inputs
  arrive. The Phase 7
  \passthrough{\lstinline!Order!} parameter is preserved on both new
  overloads.
\item
  \textbf{Materialized contractions, ETs deferred to Phase 14.}
  ...
  surface and Phase 14's eventual
