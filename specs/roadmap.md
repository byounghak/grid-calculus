...
- **Deliverables.**
  - `core/Basis.hpp` — a `Basis` value type holding $M$ and the fractional offsets $\{\boldsymbol{\tau}_\alpha\}$. Validated: offsets in $[0,1)^3$, no duplicates within a tolerance.
